    ...
    return (
        <div className="px-6 py-10 md:px-12 md:py-16 lg:px-20 max-w-5xl">
            ...
            <section className="bg-card-bg p-8 md:p-12 border-l-[8px] border-accent-red mb-16">
                <div className="text-lg md:text-xl font-sans leading-relaxed text-black/90 max-w-none">
                    <MDXRemote source={intro?.content || "Instrumen demonstrasi dari ide-ide Pandu Ibuku."} />
                </div>
            </section>
